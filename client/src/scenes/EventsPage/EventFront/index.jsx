...
import Image from "../../../../src/assetss/images/book/Music.png";
import { useNavigate } from 'react-router-dom';
import BannerStart from 'components/BannerStart'
import "./index.css";
import kendy from "../../../../src/assetss/images/about/kendy.png";
    ...
    <div className="container">
      <div className="row mx-auto">
        <div className="col-lg-6 mx-auto text-center my-5">
          {/* Logo */}
          <img className="mx-auto h-40px" src="assets/images/logo-light.svg" alt="logo" />
          ...
          {/* Bottom footer link */}
          <div className="mt-3 text-white">©2021 <a href="https://www.webestica.com/" className="text-reset btn-link text-primary-hover" target="_blank">Eduport</a>. All rights reserved. </div>
        </div>
      </div>
    </div>
  </footer>
