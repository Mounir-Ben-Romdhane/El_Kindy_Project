  ...
  useEffect(() => {
    const fetchClasses = async () => {
      try {
        ...
        console.error('Error fetching classes:', error);        setOpen(false);
                                      ...
                                      <td colSpan="3">
                                        <table className="table table-dark-gray align-middle p-4 mb-0 table-hover mt-3">
                                          <thead>
                                            <tr className='bg-blue'>
                                              ...
                                              <th className="border-0 rounded-end">Student Sheets</th>
                                            </tr>
                                          </thead>
                                          <tbody>
                                            {showStudents[classId][course._id].length > 0 ? (
                                              showStudents[classId][course._id].map((student, index) => (
                                                <tr key={index}>
                                                  ...
                                                  <td>
                                                    ...
                                                    <a href="#" className="fas fa-fw fa-plus"
                                        ...
                                        {ficheEleves.length > 0 && (
                                          <div className="col-lg-9">
                                            <div className="card bg-transparent border rounded-3 mt-3">
                                              <div className="card-header bg-transparent border-bottom">
                                                ...
                                                <table className="table table-striped">
                                                  <thead>
                                                    <tr className="card-header-title mb-0 bg-blue">
                                                      ...
                                                      <th className="border-0 ">Observation</th>
                                                  ...
                                                  <tbody>
                                                    {ficheEleves.length > 0 ? (
                                                      ...
                                                      <tr>
                                                        <td colSpan="5">
                                                          <div className="alert alert-info" role="alert">
                                                            No student sheets for this student yet.
                                                          </div>
                                                        </td>
                                                      </tr>
                                                    )}
