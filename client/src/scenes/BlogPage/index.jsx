      ...
      <div className="row align-items-center justify-content-xl-between g-4 g-md-5">
          ...
          <div className="row g-3 mb-3 mb-lg-0">
            ...
            <div className="col-sm-6">
              <div className="d-flex align-items-center">
                {/* Icon */}
                <div className="icon-lg fs-4 text-orange bg-orange bg-opacity-10 rounded"> <i className="bi bi-book-half" /> </div>
                {/* Info */}
                <div className="ms-3">
                  <div className="d-flex">
                    <h4 className="purecounter fw-bold mb-0" data-purecounter-start={0} data-purecounter-end={600} data-purecounter-delay={100}>0</h4>
            ...
            <div className="col-sm-6">
              <div className="d-flex align-items-center">
                {/* Icon */}
                <div className="icon-lg fs-4 text-info bg-info bg-opacity-10 rounded"> <i className="fas fa-university" /> </div>
                {/* Info */}
                <div className="ms-3">
                  <div className="d-flex">
                    <h4 className="purecounter fw-bold mb-0" data-purecounter-start={0} data-purecounter-end={400} data-purecounter-delay={100}>0</h4>
                    <span className="h4 mb-0">+</span>
                  </div>
        ...
        <div className="col-lg-5 col-xl-6 text-center position-relative">
          ...
          <div className="p-3 card card-body shadow rounded-4 position-absolute top-0 start-0 translate-middle ms-5 z-index-1 d-none d-xl-block">
            <div className="d-flex justify-content-between">
              ...
              <div className="avatar">
                <img className="avatar-img rounded-circle shadow" src="assets/images/avatar/04.jpg" alt="avatar" />
              </div>
              {/* Info */}
              <div className="text-start ms-3">
                ...
                {/* Button */}
                <a href="#" className="btn btn-sm btn-danger-soft mt-2 mb-0">Join now</a>
              </div>
            </div>
          </div>
          {/* Student review */}
          ...
          <div className=" position-relative">
            ...
            {/* Image */}
            <img src="assets/images/element/06.png" className="position-absolute bottom-0 start-50 translate-middle-x" alt />
          </div>
        </div>
        {/* Right content END */}
      </div>
        ...
        <div className="col-md-12">
          <div className="bg-light rounded-3 p-4">
            ...
            <div className="tiny-slider arrow-round arrow-creative arrow-blur arrow-hover py-1">
              <div className="tiny-slider-inner" data-autoplay="true" data-gutter={80} data-arrow="true" data-dots="false" data-items={5} data-items-lg={3} data-items-md={2} data-items-xs={1}>
                {/* Item */}
                <div>
                  <div className="bg-body text-center rounded-2 border py-2 px-1 position-relative">
                    <img src="assets/images/element/22.svg" className="h-40px" alt />
                    <a href="#" className="text-primary-hover stretched-link"><span className="h6 ms-2">Chemistry</span></a>
                  </div>
                </div>
                {/* Item */}
                <div>
                  <div className="bg-body text-center rounded-2 border py-2 px-1 position-relative">
                    <img src="assets/images/element/23.svg" className="h-40px" alt />
                    <a href="#" className="text-primary-hover stretched-link"><span className="h6 ms-2">Physics</span></a>
                  </div>
                </div>
                {/* Item */}
                <div>
                  <div className="bg-body text-center rounded-2 border py-2 px-1 position-relative">
                    <img src="assets/images/element/21.svg" className="h-40px" alt />
                    <a href="#" className="text-primary-hover stretched-link"><span className="h6 ms-2">Technology</span></a>
                  </div>
                </div>
                {/* Item */}
                <div>
                  <div className="bg-body text-center rounded-2 border py-2 px-1 position-relative">
                    <img src="assets/images/element/24.svg" className="h-40px" alt />
                    <a href="#" className="text-primary-hover stretched-link"><span className="h6 ms-2">Health</span></a>
                  </div>
                </div>
                {/* Item */}
                <div>
                  <div className="bg-body text-center rounded-2 border py-2 px-1 position-relative">
                    <img src="assets/images/element/25.svg" className="h-40px" alt />
                    <a href="#" className="text-primary-hover stretched-link"><span className="h6 ms-2">Business</span></a>
                  </div>
                </div>
                {/* Item */}
                <div>
                  <div className="bg-body text-center rounded-2 border py-2 px-1 position-relative">
                    <img src="assets/images/element/26.svg" className="h-40px" alt />
                    <a href="#" className="text-primary-hover stretched-link"><span className="h6 ms-2">Engineer</span></a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card-body">
              ...
              <div className="d-flex justify-content-between mb-3">
                <div className="hstack gap-2">
                  ...
                  <a href="#" className="badge bg-dark text-white">6 month</a>
                </div>
              ...
              <div className="d-flex justify-content-between align-items-center mb-2">
                ...
                <span className="h6 fw-light mb-0 me-3"><i className="far fa-clock text-danger me-2" />6h 56m</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="card-body">
              ...
              <div className="d-flex justify-content-between mb-3">
                <div className="hstack gap-2">
                  ...
                  <a href="#" className="badge bg-dark text-white">8 month</a>
                </div>
                <a href="#" className="text-danger"><i className="fas fa-bookmark fa-fw" /></a>
              </div>
              {/* Title */}
              ...
              <div className="d-flex justify-content-between align-items-center mb-2">
                ...
                <span className="h6 fw-light mb-0 me-3"><i className="far fa-clock text-danger me-2" />12h 56m</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="card shadow-hover overflow-hidden bg-transparent">
            ...
            <div className="card-body">
              ...
              <div className="d-flex justify-content-between mb-3">
                <div className="hstack gap-2">
                  <a href="#" className="badge bg-info bg-opacity-10 text-info">Beginner</a>
                  <a href="#" className="badge bg-dark text-white">12 month</a>
                </div>
                <a href="#" className="h6 fw-light mb-0"><i className="far fa-bookmark fa-fw" /></a>
              </div>
              {/* Title */}
              ...
              <div className="d-flex justify-content-between align-items-center mb-2">
                ...
                <span className="h6 fw-light mb-0 me-3"><i className="far fa-clock text-danger me-2" />5h 40m</span>
              </div>
            </div>
          </div>
        </div>
                          ...
                          <div className="row g-3">
                            ...
                            <div className="col-sm-4 col-lg-6 col-xl-4">
                              <div className="d-flex align-items-center">
                                ...
                                <div>
                                  {/* Badge */}
                                  <span className="badge bg-info text-white mb-1">6 months</span>
                            ...
                            <div className="col-sm-4 col-lg-6 col-xl-4">
                              <div className="d-flex align-items-center">
                                ...
                                <div>
                                  {/* Badge */}
                                  <span className="badge bg-info text-white mb-1">12 months</span>
                            ...
                            <div className="col-sm-4 col-lg-6 col-xl-4">
                              <div className="d-flex align-items-center">
                                ...
                                <div>
                                  {/* Badge */}
                                  <span className="badge bg-info text-white mb-1">18 months</span>
                          ...
                          <div className="row g-3">
                            ...
                            <div className="col-sm-4 col-lg-6 col-xl-4">
                              <div className="d-flex align-items-center">
                                ...
                                <div>
                                  {/* Badge */}
                                  <span className="badge bg-info text-white mb-1">6 month</span>
                            ...
                            <div className="col-sm-4 col-lg-6 col-xl-4">
                              <div className="d-flex align-items-center">
                                ...
                                <div>
                                  {/* Badge */}
                                  <span className="badge bg-info text-white mb-1">12 month</span>
                            ...
                            <div className="col-sm-4 col-lg-6 col-xl-4">
                              <div className="d-flex align-items-center">
                                ...
                                <div>
                                  {/* Badge */}
                                  <span className="badge bg-info text-white mb-1">18 month</span>
    ...
    <div className="container">
      ...
      <div className="row">
        ...
        <div className="tiny-slider arrow-round arrow-creative arrow-blur">
          <div className="tiny-slider-inner" data-autoplay="true" data-arrow="true" data-dots="false" data-items={4} data-items-lg={3} data-items-md={2} data-items-xs={1}>
            {/* Card item START */}
      ...
      <div className="row justify-content-center my-4">
        <div className="col-12">
          ...
          <div className="tiny-slider arrow-round">
            <div className="tiny-slider-inner" data-arrow="false" data-autoplay="true" data-dots="false" data-gutter={80} data-items-xl={6} data-items-lg={5} data-items-md={4} data-items-sm={3} data-items-xs={2}>
              {/* Slide item START */}
              <div className="item"> <img src="assets/images/client/coca-cola.svg" alt /> </div>
              <div className="item"> <img src="assets/images/client/android.svg" alt /> </div>
              <div className="item"> <img src="assets/images/client/envato.svg" alt /> </div>
              <div className="item"> <img src="assets/images/client/microsoft.svg" alt /> </div>
              <div className="item"> <img src="assets/images/client/netflix.svg" alt /> </div>
              <div className="item"> <img src="assets/images/client/google.svg" alt /> </div>
              <div className="item"> <img src="assets/images/client/linkedin.svg" alt /> </div>
              {/* Slide item END */}
            </div>
          </div>
          {/* Slider END */}
