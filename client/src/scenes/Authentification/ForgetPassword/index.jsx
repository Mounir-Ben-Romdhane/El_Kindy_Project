...
function Index() {
    ...
    const forgotPassword = async (values) => {
        ...
        const forgotPasswordResponse = await fetch('http://localhost:3001/auth/forgot-password', {
          method: 'POST',
        ...
        if (savedForgot.status == true) {
          console.log('Email send successfully!!');
          console.log('Res', savedForgot);
          navigate('/');
        }else{
            console.log('Res', savedForgot.message);
        }
      };
                  ...
                  <div className="col-sm-10 col-xl-12 m-auto">
                    ...
                    <form onSubmit={handleSubmit}>
                      ...
                      <div style={{ display: 'grid', justifyContent: 'end' }}>
                        <div className="text-primary-hover  mt-3" style={{ fontSize: '1rem' }}>
